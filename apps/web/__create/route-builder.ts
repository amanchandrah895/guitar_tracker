  ...
  for (const file of files) {
    try {
      ...
      if (statResult.isDirectory()) {
        ...
        // Leftover unfinished SSR probe. Do not register it: it has no
        // caller, no auth, and would render every page per request.
        if (filePath.includes('/__create/ssr-test/')) {
          continue;
        }
